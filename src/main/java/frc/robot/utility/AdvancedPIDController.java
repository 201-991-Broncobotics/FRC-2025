...
public class AdvancedPIDController {
    ...
    public AdvancedPIDController(double kP, double kI, double kD, DoubleSupplier encoderPosition) { // units are the same as the units of the encoderPosition
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
    ...
    public AdvancedPIDController setSpeedLimiter(double newMaxSpeed, double newMaxAcceleration, double newMaxDeceleration) {
    ...
    public AdvancedPIDController setPowerLimiter(double newMaxPower, double newMinPower, double newInitialPower) {
    ...
    public AdvancedPIDController setPowerLimiter(double newMaxPower, double newMinPower) {
        this.maxPower = newMaxPower;
        this.minPower = newMinPower;
        return this;
    }
    ...
    public AdvancedPIDController setPositionLimiter(double newMinPosition, double newMaxPosition) {
    ...
    public AdvancedPIDController setTolerance(double newTolerance) {
        this.tolerance = newTolerance;
        return this;
    }


    public AdvancedPIDController setP2(double kP2) {
        this.kP2 = kP2;
        return this;
    }
    ...
    public void setSettingsTheSameAs(AdvancedPIDController referencePID) {
        kP = referencePID.kP;
        kI = referencePID.kI;
        kD = referencePID.kD;
